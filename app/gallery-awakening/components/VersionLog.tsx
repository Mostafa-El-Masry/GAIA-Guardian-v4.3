  ...
  return (
    <section className="space-y-3 rounded-3xl border border-base-300 bg-base-100 p-4 text-xs text-base-content">
      ...
      <div className="space-y-1 text-[11px] text-base-content/70">
        <p>
          <span className="font-semibold text-base-content">Version window:</span>{' '}
      ...
      <ul className="list-disc space-y-1 pl-4 text-[11px] text-base-content/70">
        <li>
          <span className="font-semibold text-base-content">Layout & foundations:</span> 3-column
          desktop / 2-column mobile grid for images and videos, with a fresh Gallery Awakening route
          separate from Genesis code.
        </li>
        <li>
          <span className="font-semibold text-base-content">R2 thumbnails & previews:</span> images and
        ...
        <li>
          <span className="font-semibold text-base-content">Feature of the Month:</span> auto-box logic
        ...
        <li>
          <span className="font-semibold text-base-content">Sync Center:</span> a dedicated panel that
          explains canonical rules (R2, local disk, Supabase) and surfaces a diff-style view for
          new/missing media.
        </li>
        <li>
          <span className="font-semibold text-base-content">Supabase + cache:</span> Gallery reads its
        ...
        <li>
          <span className="font-semibold text-base-content">Filters, tags & views:</span> memories can be
          browsed by tags and sorted by recently added, most viewed, or most loved.
        </li>
        <li>
          <span className="font-semibold text-base-content">Memory Pulse:</span> a lightweight summary
        ...
        <li>
          <span className="font-semibold text-base-content">Safety & resilience:</span> image and video
